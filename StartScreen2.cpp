...
StartScreen::StartScreen() {
	...
	mOnePlayerMode = new Texture("New Game", "emulogic.ttf", 32, { 230, 230, 230 });
	mTwoPlayerMode = new Texture("Load Game", "emulogic.ttf", 32, { 230, 230, 230 });
	...
	mNamco = new Texture("colinco", "namco__.ttf", 36, { 200, 0, 0 });
	mDates = new Texture("2022 COLINCO", "emulogic.ttf", 32, { 230, 230, 230 });
